...
SWIGEXPORT jint JNICALL Java_util_time_sequence_timerclock_nativelinux_linuxclockJNI_scheduleRealtime(JNIEnv *jenv, jclass jcls, jint jarg1) {
  ...
  (void)jcls;
  arg1 = (int)jarg1; 
  result = (int)scheduleRealtime(arg1);
  jresult = (jint)result; 
  return jresult;
}
